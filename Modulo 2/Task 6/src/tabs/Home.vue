<template>
  <main class="container mt-3 mb-5 col-10">
    <div class="row justify-content-between">
      <div class="col accordion" id="main-info">
        <article class="card">
          ...
          <div class="collapse show" id="about-body" data-parent="#main-info">
            <div class="card-body">
        ...
        <article class="card">
          <div class="card-header" id="history-header">
            <h2>
              <button
                class="btn btn-link btn-lg"
                type="button"
              ...
              >Background History of Government Transparency</button>
            </h2>
          </div>
          <div class="collapse" id="history-body" data-parent="#main-info">
            <div class="card-body">
      ...
      <aside class="col-4 align-self-start">
        <img
