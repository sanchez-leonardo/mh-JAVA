...
const statistics = new Vue({
  ...
  computed: {
    ...
    firstGlanceInfo(){
      return [{"party" : "Democrats", "reps" : this.number_of_democrats, "votes_pct" : parseInt(this.democrat_vote_pct)},
      {"party" : "Republicans", "reps" : this.number_of_republicans, "votes_pct" : parseInt(this.republican_vote_pct)},
      {"party" : "Independent", "reps" : this.number_of_independents, "votes_pct" : parseInt(this.independent_vote_pct)},
      {"party" : "Total", "reps" : this.number_of_senators, "votes_pct" : parseInt((this.democrat_vote_pct + this.republican_vote_pct + this.independent_vote_pct)/3)}]
    }
