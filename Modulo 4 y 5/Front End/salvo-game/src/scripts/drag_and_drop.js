...
export function dropPossible(array) {
  return (
...
export function addRotateBtn(cell, imgId) {
...
export function rotateShip(imgId) {
...
export function availableSpaceTakingIntoAccountShipRotation(cell, shipId) {
...
export function addShipToArray(shipArr, shipId, locations) {
